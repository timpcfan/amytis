...
title: "About Amytis"
date: "2026-01-07"
excerpt: "Amytis is an open-source Next.js framework for building your own digital garden — posts, series, books, notes, knowledge graph, and full-text search."
layout: "simple"
toc: true
---
...
**Amytis** is an open-source framework for building a personal digital garden — a knowledge space where ideas grow and connect over time. Unlike a traditional blog, a digital garden is a living network of writing at various stages of development: rough notes, refined essays, and everything in between.
